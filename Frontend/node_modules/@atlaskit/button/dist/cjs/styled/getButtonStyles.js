...
var _themeDefinitions = _interopRequireDefault(require("./themeDefinitions"));
...
var getPropertyAppearance = function getPropertyAppearance(property) {
  ...
  var definitions = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : _themeDefinitions.default;
...
exports.getPropertyAppearance = getPropertyAppearance;

function getButtonStyles(props) {
  // $FlowFixMe - should be fixed when theme work is done
  var baseSize = (0, _theme.fontSize)(props);
  var buttonHeight = "".concat(_theme.math.divide(_theme.math.multiply(_theme.gridSize, 4), baseSize)(props), "em");
  var compactButtonHeight = "".concat(_theme.math.divide(_theme.math.multiply(_theme.gridSize, 3), baseSize)(props), "em");
  /**
   * Variable styles
   */
  ...
  var padding = "0 ".concat((0, _theme.gridSize)(props), "px");
  ...
  var boxShadow = boxShadowColor ? (0, _styledComponents.css)(["\n        box-shadow: 0 0 0 2px ", ";\n      "], boxShadowColor) : null;
  ...
  return (0, _styledComponents.css)(["\n    align-items: baseline;\n    background: ", ";\n    border-radius: ", "px;\n    border-width: 0;\n    box-sizing: border-box;\n    color: ", " !important;\n    cursor: ", ";\n    display: inline-flex;\n    font-size: inherit;\n    font-style: normal;\n    height: ", ";\n    line-height: ", ";\n    margin: 0;\n    max-width: 100%;\n    outline: ", " !important;\n    padding: ", ";\n    text-align: center;\n    text-decoration: ", ";\n    transition: ", ";\n    transition-duration: ", ";\n    vertical-align: ", ";\n    white-space: nowrap;\n    width: ", ";\n    ", " &::-moz-focus-inner {\n      border: 0;\n      margin: 0;\n      padding: 0;\n    }\n    ", ";\n  "], background, _theme.borderRadius, color, cursor, height, lineHeight, outline, padding, textDecoration, transition, transitionDuration, verticalAlign, width, boxShadow, isLoadingStyles);
}