...
var hex2rgba = function hex2rgba(hex) {
  ...
  if (/^#([A-Fa-f0-9]{3}){1,2}$/.test(hex)) {
    ...
    color = "0x".concat(color.join('')); // $FlowFixMe - `>>` oxperand can validly take a string value

    var r = color >> 16 & 255; // $FlowFixMe - `>>` operand can validly take a string value

    var g = color >> 8 & 255; // $FlowFixMe - `>>` operand can validly take a string value

    var b = color & 255;
    return "rgba(".concat([r, g, b].join(','), ", ").concat(alpha, ")");
  }
    ...
    default: {
      background: {
        ...
        active: (0, _theme.themed)({
          light: hex2rgba(_theme.colors.B75, 0.6),
      ...
      boxShadowColor: {
        focus: (0, _theme.themed)({
          light: hex2rgba(_theme.colors.B200, 0.6),
          dark: _theme.colors.B75
        }),
        focusSelected: (0, _theme.themed)({
          light: hex2rgba(_theme.colors.B200, 0.6),
