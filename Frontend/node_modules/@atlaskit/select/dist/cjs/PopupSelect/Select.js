...
function (_PureComponent) {
  ...
  function PopupSelect() {
    ...
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this)), "focusTrap", void 0);
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this)), "menuRef", void 0);
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this)), "selectRef", void 0);
    ...
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this)), "handleKeyDown", function (_ref) {
      var key = _ref.key;
    ...
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this)), "handleClick", function (_ref2) {
    ...
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this)), "handleSelectChange", function (value, actionMeta) {
    ...
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this)), "initialiseFocusTrap", function () {
      var trapConfig = {
    ...
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this)), "resolveTargetRef", function (popperRef) {
      return function (ref) {
        _this.targetRef = ref;
        popperRef(ref);
      };
    });
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this)), "resolveMenuRef", function (popperRef) {
      return function (ref) {
        _this.menuRef = ref;
        popperRef(ref);
      };
    });
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this)), "getSelectRef", function (ref) {
      _this.selectRef = ref;
    });
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this)), "getItemCount", function () {
    ...
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this)), "getMaxHeight", function () {
    ...
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this)), "showSearchControl", function () {
      var searchThreshold = _this.props.searchThreshold;
      return _this.getItemCount() > searchThreshold;
    });
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this)), "renderSelect", function () {
      ...
      var popper = _react.default.createElement(_reactPopper.Popper, mergedPopperProps, function (_ref3) {
        var placement = _ref3.placement,
            ref = _ref3.ref,
            style = _ref3.style;
        return _react.default.createElement(_reactNodeResolver.default, {
          innerRef: _this.resolveMenuRef(ref)
        }, _react.default.createElement(_components.MenuDialog, {
          style: style,
  ...
  (0, _createClass2.default)(PopupSelect, [{
    ...
    value: function render() {
      ...
      return _react.default.createElement(_reactPopper.Manager, null, _react.default.createElement(_reactPopper.Reference, null, function (_ref4) {
        var ref = _ref4.ref;
        return _react.default.createElement(_reactNodeResolver.default, {
